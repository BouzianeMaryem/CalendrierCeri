...
public class User {
    ...
    public User(String nom, String prenom, String fonction, String username, String password) {
        ...
        this.initiales = extractInitiales(nom, prenom); // extraction des initiales
    }

    // Méthode pour extraire les initiales à partir du nom et du prénom
    private String extractInitiales(String nom, String prenom) {
        // Vérifie si le nom ou le prénom est null ou vide afin d'éviter les erreurs
        if (nom == null || nom.isEmpty() || prenom == null || prenom.isEmpty()) {
            return "";
        }
        // Retourne la première lettre du prénom et du nom en majuscules
